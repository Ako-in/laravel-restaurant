        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                @else
                    {{-- 一般ユーザー用のナビゲーション --}}
                    <!-- Logo -->
                    <div class="flex-shrink-0 flex items-center p-3 d-flex gap-3">
                    ...
                    <div class="flex items-center ">
                        <a href="{{route('customer.menus.index')}}">メニュー</a>
                    </div>
                    {{-- カート --}}
                    <div class="flex items-center">
                        <a href="{{ route('carts.index') }}" class="btn btn-primary">カート</a>
                    </div>
                    {{-- 注文履歴,決済画面 --}}
                    <div class="flex items-center">
                        <a href="{{ route('checkouts.index') }}" class="btn btn-primary">注文履歴・決済</a>
                    </div>
                @endif
            ...
            <!-- 更新用のフォーム -->
            {{-- <form action="{{ route('checkouts.update') }}" method="POST">
                @csrf
                @method('PUT')
